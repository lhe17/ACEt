...
\begin{figure}[h!]
  ...
  \caption{Plots of variance curves of the example data set fitted by the ACE(t) and ACE(t)-p model with 10 interior knots for each component. Left: the ACE(t) model. Right: the ACE(t)-p model.}
  \label{fig:knot_10}
\end{figure}
...
test$p
```
The result shows that the null hypothesis of the log-linearity is not rejected.
